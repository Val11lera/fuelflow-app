...
export default function TermsPage() {
  ...
  // Robust "reached end" detection + also enable if content not scrollable
  useEffect(() => {
    ...
    const check = () => {
      ...
      if (atBottom || el.scrollHeight <= el.clientHeight + 1) {
    ...
    ro.observe(el);
    const t = setTimeout(check, 300); // fonts/images settle
...
/* ------------------- LEGAL BODY (screen) ------------------- */
/* === This is the long, detailed version you shared as your “current code”. === */
  ...
  return (
    <div className="space-y-2 text-black">
      ...
      <PrintSection title="3. Orders, Minimums & Credit">
        <ul>
          <li>Orders are subject to acceptance, stock availability, credit approval and site safety verification.</li>
          <li>Minimum order volumes may apply and vary by region/product/logistics.</li>
      ...
      <PrintSection title="9. Invoicing, Payment & Remedies">
        <ul>
          ...
          <li>
            Late payment: interest at the greater of 4% p.a. above Barclays base or the statutory rate under the Late Payment Act, plus fixed recovery costs and reasonable legal fees.
          </li>
      ...
      <PrintSection title="16. Miscellaneous (incl. E-sign, Confidentiality, Notices, Law)">
        <ul>
          ...
          <li>
            <strong>E-sign / Evidence:</strong> electronic acceptance (checkbox/click/email), IP, user-agent, time stamp and version are admissible as evidence.
          </li>
          <li>
