...
export default function Login() {
  ...
  async function handleLogin() {
    try {
      ...
      // 1) LOGIN ONLY – no allowlist, no admin check
      ...
      // 3) HARD redirect – this is the key bit
      if (typeof window !== "undefined") {
        window.location.href = "/documents"; // change if your client page is different
      }
    } catch (e: any) {
